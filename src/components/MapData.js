...
const iconMarkup = renderToStaticMarkup(<div className="python-logo"><SiPython /></div>); 
...
const MapData = () => {
  ...
  return groups.map((group, index) => < Marker key={index.toString()} position={[group.latitude, group.longitude]} icon={customMarkerIcon} >
    <Popup>
      <div className="div-container">
        <b>{group.name}</b>
        <div className="links">
          {group.twitter ? (<a href={group.twitter} target="_blank" rel="noreferrer"><FaTwitter /></a>) : ''}
          {group.web ? (<a href={group.web} target="_blank" rel="noreferrer">< BiWorld /></a>) : ''}
          {group.telegram ? (<a href={group.telegram} target="_blank" rel="noreferrer"><FaTelegram /></a>) : ''}
          {group.mail ? (<a href={group.mail} target="_blank" rel="noreferrer"><FiMail /></a>) : ''}
          {group.meetup ? (<a href={group.meetup} target="_blank" rel="noreferrer"><FaMeetup /></a>) : ''}
          {group.video ? (<a href={group.video} target="_blank" rel="noreferrer"><FaVideo /></a>) : ''}
          {group.discord ? (<a href={group.discord} target="_blank" rel="noreferrer"><FaDiscord /></a>) : ''}
        </div>
      </div>
    </Popup>
  </Marker >);
