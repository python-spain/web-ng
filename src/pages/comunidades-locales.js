    ...
    <div className="container pb-6 pt-6 pt-md-10 pb-md-10">
      <div className="row justify-content-start">
        <div className="col-12 col-md-8">
          ...
          <p className="content mb-2">¿Crees que falta alguna?<a href="https://github.com/python-spain/web/edit/master/content/pages/comunidades-locales.md" target="_blank" rel="noreferrer">¡Puedes añadirla!</a></p>
